...
class _ProductRentRemoteGateway implements ProductRentRemoteGateway {
  ...
  Future<HttpResponse<BaseResponse<VendingMachineResponse>>> checkRentalOption(
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(
        _setStreamType<HttpResponse<BaseResponse<VendingMachineResponse>>>(
            Options(method: 'GET', headers: _headers, extra: _extra)
                .compose(_dio.options, '/project/product-rent/check-rental',
  ...
  @override
  Future<HttpResponse<BaseResponse<ProductRentResponse>>>
      getActiveRent() async {
    const _extra = <String, dynamic>{};
  ...
  Future<HttpResponse<BaseResponse<ProductRentResponse>>> completeRent(
      {required code, required productRentId}) async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(
        _setStreamType<HttpResponse<BaseResponse<ProductRentResponse>>>(
            Options(method: 'POST', headers: _headers, extra: _extra)
                .compose(_dio.options, '/project/product-rent/complete-rent',
                    queryParameters: queryParameters, data: _data)
                .copyWith(baseUrl: baseUrl ?? _dio.options.baseUrl)));
    final value = BaseResponse<ProductRentResponse>.fromJson(_result.data!);
    final httpResponse = HttpResponse(value, _result);
  ...
  Future<HttpResponse<BaseResponse<ProductRentResponse>>> startRent(
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(
        _setStreamType<HttpResponse<BaseResponse<ProductRentResponse>>>(Options(
            ...
            .compose(_dio.options, '/project/product-rent/start-rent',
                queryParameters: queryParameters, data: _data)
            .copyWith(baseUrl: baseUrl ?? _dio.options.baseUrl)));
    final value = BaseResponse<ProductRentResponse>.fromJson(_result.data!);
    final httpResponse = HttpResponse(value, _result);
