...
class _ContactsRemoteGateway implements ContactsRemoteGateway {
  ...
  Future<HttpResponse<BaseResponse<GetContactsResponse>>> getContacts() async {
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(
        _setStreamType<HttpResponse<BaseResponse<GetContactsResponse>>>(
            Options(method: 'GET', headers: _headers, extra: _extra)
                .compose(_dio.options, 'project/contact-info/get-contacts',
  ...
  @override
  Future<HttpResponse<BaseResponse<dynamic>>> sendFeedback(
      {required email, required subject, required message}) async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(
        _setStreamType<HttpResponse<BaseResponse<dynamic>>>(Options(
            ...
            .compose(_dio.options, 'common/user/send-email',
                queryParameters: queryParameters, data: _data)
            .copyWith(baseUrl: baseUrl ?? _dio.options.baseUrl)));
