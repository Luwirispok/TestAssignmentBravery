...
class _NotificationsRemoteGateway implements NotificationsRemoteGateway {
  ...
  @override
  Future<HttpResponse<BaseResponse<dynamic>>> setNotificationsToken(
      pushToken) async {
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(
        _setStreamType<HttpResponse<BaseResponse<dynamic>>>(Options(
            ...
            .compose(_dio.options, '/common/push/set-token',
  ...
  @override
  Future<HttpResponse<BaseResponse<dynamic>>> removeNotificationsToken(
      pushToken) async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(
        _setStreamType<HttpResponse<BaseResponse<dynamic>>>(Options(
                ...
                extra: _extra,
                contentType: 'application/x-www-form-urlencoded')
            .compose(_dio.options, '/common/open/push/remove-token',
                queryParameters: queryParameters, data: _data)
            .copyWith(baseUrl: baseUrl ?? _dio.options.baseUrl)));
    final value = BaseResponse<dynamic>.fromJson(_result.data!);
    final httpResponse = HttpResponse(value, _result);
