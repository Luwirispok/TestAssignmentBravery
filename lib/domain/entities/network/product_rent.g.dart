...
ProductRent _$ProductRentFromJson(Map<String, dynamic> json) => ProductRent(
      ...
      createdAt:
          DateTimeJsonFormatter.dateTimeFromEpochUs(json['createdAt'] as int?),
      updatedAt:
          DateTimeJsonFormatter.dateTimeFromEpochUs(json['updatedAt'] as int?),
      ...
      startedAt:
          DateTimeJsonFormatter.dateTimeFromEpochUs(json['startedAt'] as int?),
      endedAt:
          DateTimeJsonFormatter.dateTimeFromEpochUs(json['endedAt'] as int?),
      postpaidAmount: (json['postpaidAmount'] as num?)?.toDouble(),
      prepayAmount: (json['prepayAmount'] as num).toDouble(),
      statusPostpaidRefund: PostpaidRefundStatusExtension.fromValue(
          json['statusPostpaidRefund'] as int?),
...
Map<String, dynamic> _$ProductRentToJson(ProductRent instance) =>
    <String, dynamic>{
      ...
      'statusPostpaidRefund':
          PostpaidRefundStatusExtension.toValue(instance.statusPostpaidRefund),
