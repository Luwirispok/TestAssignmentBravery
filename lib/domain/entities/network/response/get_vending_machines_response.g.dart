...
GetVendingMachinesResponse _$GetVendingMachinesResponseFromJson(
...
Map<String, dynamic> _$GetVendingMachinesResponseToJson(
        GetVendingMachinesResponse instance) =>
    <String, dynamic>{
