...
import '../../core/entities/phone_number.dart';
import '../../domain/entities/network/product_rent.dart';
...
class NavigateAction extends BlocAction with _$NavigateAction {
  ...
  factory NavigateAction.navigateToContacts(NavigateType navigateType) = NavigateToContacts;
}
