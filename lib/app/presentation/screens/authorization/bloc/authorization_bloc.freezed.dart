...
class _$SendCodeClicked implements SendCodeClicked {
  ...
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType && other is SendCodeClicked);
  }
...
abstract class $PrivacyPolicyClickedCopyWith<$Res> {
  factory $PrivacyPolicyClickedCopyWith(PrivacyPolicyClicked value,
          $Res Function(PrivacyPolicyClicked) then) =
      _$PrivacyPolicyClickedCopyWithImpl<$Res>;
}

/// @nodoc
class _$PrivacyPolicyClickedCopyWithImpl<$Res>
    extends _$AuthorizationEventCopyWithImpl<$Res>
    implements $PrivacyPolicyClickedCopyWith<$Res> {
  _$PrivacyPolicyClickedCopyWithImpl(
      PrivacyPolicyClicked _value, $Res Function(PrivacyPolicyClicked) _then)
...
class _$PrivacyPolicyClicked implements PrivacyPolicyClicked {
  ...
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType && other is PrivacyPolicyClicked);
  }
    ...
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            const DeepCollectionEquality()
                .equals(other.numberEntering, numberEntering) &&
