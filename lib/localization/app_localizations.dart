...
class AppLocalizations {
  ...
  String get authorization => _localizedStrings['authorization'] ?? '';
  ...
  String get chooseVendingMachine => _localizedStrings['chooseVendingMachine'] ?? '';
  String get informationAboutVendingMachine => _localizedStrings['informationAboutVendingMachine'] ?? '';
  String availablePowerBank(String quantity) => getFormattedString(
    _localizedStrings['availablePowerBank'] ?? '',
    [quantity],
  );
  String freeCells(String quantity) => getFormattedString(
    _localizedStrings['freeCells'] ?? '',
    [quantity],
  );
  String get descriptionOfPromotion => _localizedStrings['descriptionOfPromotion'] ?? '';
  String get description => _localizedStrings['description'] ?? '';
  String get scan => _localizedStrings['scan'] ?? '';
